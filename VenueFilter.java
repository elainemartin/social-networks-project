...
public class VenueFilter {
	public static void main(String[] args) throws FileNotFoundException {
		File original = new File("venues.txt");
		File output = new File("SFvenues.txt");

		// System.out.println("Row count: " + checkLineCount(original));
		filterVenues(original, output);
	}
	...
	public static void filterVenues(File original, File output) throws FileNotFoundException {
